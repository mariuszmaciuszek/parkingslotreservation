...
class ReservationAboutToEndManagerTest {
    @SpyBean
    ...
    @Autowired
    @InjectMocks
    private ReservationAboutToEndManager reservationAboutToEndManager;
    ...
    void process() {
        final List<Reservation> reservations =
                reservationRepository.findAllReservationAboutToEnd(SEARCHING_PERIOD_IN_MINUTES);
        ...
        assertThat(outboxEventCreated).hasSize(reservations.size()).allMatch(e -> e.getEventType()
                .equals(OutboxEvent.OutboxEventType.RESERVATION_END_REMINDER));
